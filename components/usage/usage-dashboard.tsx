  ...
  return (
    <th className={`text-left p-3 text-sm font-medium ${className}`}>
      <MobileFriendlyTooltip
        ...
        align="center"
        iconSize="sm"
        triggerClassName="font-inherit text-inherit"
      >
        {children}
      </MobileFriendlyTooltip>
    </th>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b">
                      ...
                      >
                        <span className="hidden sm:inline">Tokens In</span>
                      ...
                      <TableHeaderWithTooltip
                        ...
                        className="text-right"
                      >
                        <span className="hidden sm:inline">Tokens Out</span>
                    ...
                    {items.map((item) => (
                      <tr key={item.id} className="border-b hover:bg-muted/50">
                        ...
                        <td className="p-2 sm:p-3 text-xs sm:text-sm text-right">
                          <span className="sm:hidden">
                            {item.tokensIn > 1000
                              ? `${(item.tokensIn / 1000).toFixed(1)}k`
                              : item.tokensIn.toString()}
                          </span>
                          <span className="hidden sm:inline">
                        ...
                        <td className="p-2 sm:p-3 text-xs sm:text-sm text-right">
                          <span className="sm:hidden">
                            {item.tokensOut > 1000
                              ? `${(item.tokensOut / 1000).toFixed(1)}k`
                              : item.tokensOut.toString()}
                          </span>
                          <span className="hidden sm:inline">
