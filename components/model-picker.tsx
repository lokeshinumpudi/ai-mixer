...
function ModelCard({
  ...
  return (
    ...
    >
      ...
      >
        <CardContent className="p-3 md:p-4 flex flex-col h-28 md:h-32">
          ...
          <div className="flex items-center justify-between mt-1.5 md:mt-2 pt-1.5 md:pt-2 border-t border-border/50">
  ...
  return (
    <MobileFriendlyTooltipProvider>
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent
          className={cn(
            "flex flex-col transition-all duration-300 p-3 md:p-6",
            isExpanded ? "max-w-6xl max-h-[90vh]" : "max-w-md max-h-[75vh]"
          )}
          ref={useAnimeOnMount({
            opacity: [0, 1],
            translateY: [12, 0],
        ...
        >
          <DialogHeader className="space-y-2 md:space-y-3">
            ...
            {userType === "free" && (
              <div className="bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-950/20 dark:to-orange-950/20 p-2 md:p-3 rounded-lg border border-amber-200/50 dark:border-amber-800/30">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <Button
                    size="sm"
                    className="bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white border-0 text-xs h-6 md:h-7 px-2 md:px-3 shrink-0"
                    onClick={() => {
                      setOpen(false);
                      const paymentUrl =
                        process.env.NEXT_PUBLIC_RAZORPAY_PAYMENT_PAGE_URL || "";
          ...
          {isExpanded && (
            <div className="relative mb-3 md:mb-4">
              ...
              />
              {/* Capability filters */}
              <div className="mt-2 md:mt-3 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-1.5 md:gap-2">
                <MobileFriendlyTooltip
          ...
          <div className="flex-1 overflow-y-auto px-0.5 md:px-1 -mx-0.5 md:-mx-1">
            {!isExpanded ? (
              ...
              <div>
                <div className="flex items-center justify-between mb-2 md:mb-4">
                  ...
                  <Button
                    ...
                    className="text-xs text-muted-foreground hover:text-foreground flex items-center gap-1 h-6 md:h-8 px-2"
                  >
                    <span>Show all</span>
                    <svg
                      className="size-3"
                  ...
                  {filteredModels.slice(0, 8).map((model) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          "flex items-center gap-2 md:gap-2.5 p-2 md:p-2.5 rounded-lg border-2 transition-all duration-200 cursor-pointer w-full text-left",
                          isSelected &&
                            enabled &&
